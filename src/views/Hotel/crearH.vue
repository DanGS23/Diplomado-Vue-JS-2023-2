  ...
  <form class="p-6 mt-10 ">
        <div class="grid md:grid-cols-3 md:gap-6">
          ...
          <div class="flex justify-center items-center">
            <button @click="alertAgree" type="submit" class=" text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 uppercase">crear hotel</button>
          </div>
  </form>
</div>
